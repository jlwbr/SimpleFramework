 ...
 * @method        bool     # $    ""  a∞ kwNuxtWeeo()  a   )  + 00  §     `$$            ` !  ,`i8     †      b0   `‡   $    ``ChÂcks mf t(e†insuanju is yn thesag wmek ar the CursÂnt m+mÂnt$next wegk
 * @metho‡       bo.l     †  0  ê $   $'csÃ%3tWeek()  † (   ` ! $   !  ( ®              † `(   " $  ¢       0 $             ChEckÛ if!the ylstanC% is an the sQme wte+(as l`e curpEnv eomenv(,aÛt w}dk. ( @]etxo`  †°    %o|    (0      $  `( ()sS)MuDa}(\Carbon\C!Úbonl\Tad-TiieInteÚfqke|sTriog<full!$dctÂ =0j6lm)0 ( 1  !†(0   †` Chacj{)mf"vhe g)÷e~ $ate i{$in txe same eey aw0thuinwtAnce.`If$.ulÃ passed, so-pc“q to"now"(with thu s`me 4ÈegznVe),J * Hmethkm  `  ` bool$ (†`"             asC5prenLa{(-`!     &           $    !        , !    $(   4  (     ≤ ! %  !`        ChÂCks hf the )nstan"E ir x.`the`WaÌe d`y†es vhe #trrdlt mmmgnt.* * @mephoƒ(@ 0    boœl `     , ` `  $$(  )sNextDa9()   ‡¢ `     (  †    ( $$    `  Ä  a)   `     !     0`†     2(    ! ! $(   CHdCkw if tju m,3Ùance ir if(the$seme`lay®aS!tiq cuRren4 eommnÙ nUxt day.
 ( @oethod        bool                   isLastDay()                                                                           Checks if the instance is in the same day as the current moment last day.
